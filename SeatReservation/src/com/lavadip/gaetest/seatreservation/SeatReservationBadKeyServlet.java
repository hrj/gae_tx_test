...
public class SeatReservationBadKeyServlet extends HttpServlet {
  ...
  private boolean reserveSeatAttempt(final String ownerName, final String seatId) throws ConcurrentModificationException {
    ...
    try {
      try {
      	// WARNING: The below code is wrong! The datastore.get(Transaction, Key) variant should be used
      	// This is just to demo the wrong behavior. Look at SeatReservationKeyBased for the correct implementation.
